...
spa.fake = (function() {
  ...
  makeFakeId = function() {
    var fake_id = 'id_' + String(fakeIdSerial);
    fakeIdSerial = fakeIdSerial + 1;
    return fake_id;
  };
  ...
  mockSio = (function() {
    ...
    emit_sio = function(msg_type, data) {
      ...
      // simulate sending of 'updateavatar' message and data to server
      if (msg_type === 'updateavatar' && callback_map.listchange)
      {
        // simulate receipt of 'listchange' message
        for (i = 0; i < peopleList.length; i = i + 1)
        {
        ...
        // execute callback for the 'listchage' message
