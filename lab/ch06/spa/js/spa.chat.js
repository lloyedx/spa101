...
spa.chat = (function() {
  ...
  // Purpose: Ensure chat slider is in the requested position
  // Arguments:
  //   * position_type - enum('closed', 'opened', or 'hidden')
  //   * callback - optional callback at the end of slider 
  //       animation. (the callback receives a jQuery collection 
  //       representing the slider DOM element as its single 
  //       argument)
  // Action:
  //   Leaves slider in current state if it matches requested 
  //   position, otherwise animate to requested position.
  // Returns:
  ...
  setSliderPosition = function(position_type, callback) {
    ...
    else if (position_type === stateMap.position_type)
    {
      if (position_type === 'opened')
      {
        jqueryMap.$input.focus();
