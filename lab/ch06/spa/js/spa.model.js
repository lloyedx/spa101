...
spa.model = (function() {
  ...
  //     provided unique client id.
  //   * login( <username> ) - login as the user with the provided 
  ...
  //
  // jQuery global custom events publishes by the object include:
  ...
  //   * get_id_anon() - return true if object is anonymous
  //
  // The attributes for a person object include:
  //   * cid - string client id. This is always defined, and is
  //     only different from the id attribute if the client data
  ...
  makeCid = function() {
    var cid = 'c' + String(stateMap.cid_serial);
    stateMap.cid_serial = stateMap.cid_serial + 1;
    return cid;
  };
  ...
  // chat messaging.
  // 
  // Its public method include:
  //   * join() - join the chat room. This routine sets up
  ...
  //     It publishes an 'spa-updatechat' global custom event.
  ...
  //     people list and avatar list (the css_map in the
  //     person objects). The update_avtr_map must have the form
  //     { person_id: personid, css_map: css_map }
  //
  ...
  chat = (function() {
    ...
    send_msg = function(msg_text) {
      ...
      else
      {
        ...
        // We publish a 'spa-updatechat' global event, so we can
