...
spa.avtr = (function() {
  ...
  onHeldstartNav = function(event) {
    ...
    else
    {
      ...
      offset_target_map.top = offset_target_map.top - offset_nav_map.top;
      offset_target_map.left = offset_target_map.left - offset_nav_map.left;
  ...
  onHeldmoveNav = function(event) {
    ...
    if (drag_map)
    {
      drag_map.top = drag_map.top + event.px_delta_y;
      drag_map.left = drag_map.left + event.px_delta_x;
  ...
  //          values we do not expect to change during a user
  //          session.
  // Action:
  ...
  // Purpose: Directs the module to begin offer its features 
  //          to the user
  // Arguments:
  //   * $container - container to use
  // Action:
  //   Provide avatar interface for chat users.
  // Returns: true
  // Throws: none
  //
